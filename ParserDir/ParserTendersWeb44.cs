...
namespace ParserTenders.ParserDir
{
    public class ParserTendersWeb44 : ParserWeb
    {
        ...
        private readonly List<string> _listUrls = new List<string>
        {
            ...
            "https://zakupki.gov.ru/epz/order/extendedsearch/results.html?morphology=on&search-filter=Дате+размещения&sortDirection=false&recordsPerPage=_50&showLotsInfoHidden=false&fz44=on&sortBy=PUBLISH_DATE&af=on&currencyIdGeneral=-1&customerPlaceWithNested=on&customerPlace=5277409&pageNumber=1"
        };
